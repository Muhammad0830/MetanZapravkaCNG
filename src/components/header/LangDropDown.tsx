  ...
  return (
    <div className="relative flex justify-center items-center">
      ...
      <motion.div
        ...
        className="z-0 absolute right-[20%] flex flex-col gap-1 p-2 rounded-sm bg-background-secondary border border-[#d1d5db] dark:border-[#4b5563] origin-top-right"
      >
        <Link
          href={pathName}
          ...
          locale="uz"
          className={cn(
            "px-2 py-0.5 hover:bg-primary rounded-sm transition-colors duration-150 text-black dark:text-white",
